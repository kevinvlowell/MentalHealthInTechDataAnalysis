...
write_csv(data2016_survey, "dataset/2016_survey_names_recoded.csv")

write_csv(data2018_recode, "dataset/2018_mental_health_in_tech_names_recoded.csv")

write_csv(data2018_demographics, "dataset/2018_demographics_names_recoded.csv")

write_csv(data2018_survey, "dataset/2018_survey_names_recoded.csv")
