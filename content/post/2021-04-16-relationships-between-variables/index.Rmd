...
When we compare self-reported prevalence of mental health problems, then and now, we see that the most popular combination of responses (`n=583`, in red) is reporting "yes" to having had a past mental health disorder and "no" to having a current mental health disorder, followed by the orange cell (`n=583`), reporting "no" to having neither a past nor present mental health disorder. 
