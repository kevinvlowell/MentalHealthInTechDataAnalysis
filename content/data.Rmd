...
* Describe where/how to find data.
  ...
  * Our data comes from the [OSMI Mental Health in Tech Survey](https://osmihelp.org/research). Open Sourcing Mental Illness (OSMI) is a "non-profit dedicated to raising awareness, educating, and providing resources to support wellness in the tech and open source communities." We focus on the 2016 survey, as this as the most responses, but also compare to the survey responses from 2014-2021. 
