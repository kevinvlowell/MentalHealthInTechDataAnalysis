...
We assess these first univariately, then in relation to each other, and then in relation to time. Temporally, we want to address whether there are changes in the response pattern or relationship of response patterns over the two years of survey data we combined from 2016 and 2018. 
